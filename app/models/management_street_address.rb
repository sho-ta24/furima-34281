class ManagementStreetAddress
  ...
  def save
    ...
    # 配送先住所の情報を保存
    StreetAddress.create(postal_code: postal_code, prefecture_id: prefecture_id, city: city, address: address, phone_number: phone_number, building: building, management_id: management.id)
  end
end
