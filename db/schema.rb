...
ActiveRecord::Schema.define(version: 2021_07_07_054250) do
  ...
  create_table "street_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["management_id"], name: "index_street_addresses_on_management_id"
  end
  ...
  add_foreign_key "street_addresses", "managements"
end
